...
DEBIAN_FRONTEND=noninteractive apt -qq -yy install devscripts lintian build-essential automake autotools-dev cmake extra-cmake-modules qtbase5-dev qtdeclarative5-dev
